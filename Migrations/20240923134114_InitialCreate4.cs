        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NeighborhoodName = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    BlockNumber = table.Column<string>(type: "text", nullable: true),
                    ParcelNumber = table.Column<string>(type: "text", nullable: false),
                    PlantedProduct = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "UserId", "AuthToken", "Mail", "Password", "Username" },
                values: new object[] { 1, "asd", "testmail@gmail.com", "123", "test" });
